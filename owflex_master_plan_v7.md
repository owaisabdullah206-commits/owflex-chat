...
| Lead capture log (name/email/phone) | ✅ | ✅ | ✅ | ✅ |
| Basic stats (chats, leads, this month) | ✅ | ✅ | ✅ | ✅ |
| Embed JS snippet | ✅ | ✅ | ✅ | ✅ |
| Separate client login | ✅ | ✅ | ✅ | ✅ |
| Multi-bot dev dashboard | ✅ | ✅ | ✅ | ✅ |
| Knowledge base / FAQ editor | ❌ | ✅ | ✅ | ✅ |
| Unanswered questions list | ❌ | ✅ | ✅ | ✅ |
| Weekly email digest to client | ❌ | ✅ | ✅ | ✅ |
| Chatbot branding (colors, name) | ❌ | ✅ | ✅ | ✅ |
| PayFast + Lemon Squeezy billing | ❌ | ✅ | ✅ | ✅ |
| Credits system (premium models) | ❌ | ✅ | ✅ | ✅ |
| Model selector per bot | ❌ | ✅ | ✅ | ✅ |
| PDF upload → knowledge base | ❌ | ❌ | ✅ | ✅ |
| Website scraping (Firecrawl) | ❌ | ❌ | ✅ | ✅ |
| White label (remove OwFlex branding) | ❌ | ❌ | ✅ | ✅ |
| Custom subdomain for client portal | ❌ | ❌ | ✅ | ✅ |
| Agency sub-tenant management | ❌ | ❌ | ✅ | ✅ |
| Human handoff / escalation | ❌ | ❌ | ✅ | ✅ |
| Auto model routing (smart tier) | ❌ | ❌ | ✅ | ✅ |
| Local ONNX embeddings (BGE-M3) | ❌ | ❌ | ✅ | ✅ |
| Webhook integrations (Zapier, n8n) | ❌ | ❌ | ❌ | ✅ |
| API access (BYOK) | ❌ | ❌ | ❌ | ✅ |
| Urdu / Roman Urdu language support | ❌ | ❌ | ❌ | ✅ |
| Advanced analytics dashboard | ❌ | ❌ | ❌ | ✅ |

**Permanently out of scope:** Visual flow builder, social media channels,
voice/audio, built-in CRM, prompt A/B testing.
...
| Tier | PKR/mo | USD/mo | Bots | Messages/mo | Leads | Storage | Model | White Label |
|------|--------|--------|------|-------------|-------|---------|-------|-------------|
| **Free** | ₨0 | $0 | 1 | 200 | 50 | 5MB | Flash only | ❌ |
| **Starter** | ₨2,000 | $9 | 2 | 2,000 | Unlimited | 25MB | Budget tier | ❌ |
| **Pro** | ₨6,000 | $19 | 5 | 10,000 | Unlimited | 100MB | Mid-range | ❌ |
| **Agency** | ₨15,000 | $49 | 20 | 50,000 | Unlimited | 500MB | All tiers | ✅ |

All plans: credits purchasable at any time for premium model access.
Annual discount: 2 months free (pay 10, get 12).

### Why These Numbers Hold

- ₨2,000 is below the impulse-buy ceiling for a Pakistani freelancer
- Chatbase charges $19/month (no white label) for equivalent usage — OwFlex is
  3x cheaper locally
- Stammer.ai (closest agency competitor) charges $497/mo — 33x cheaper
- Free tier is real: 200 messages is enough to demo to 3 clients in a meeting

### Profitability at Scale

**Month 3 — 50 Starter + 10 Pro users:**
```
Revenue:  (50 × ₨2,000) + (10 × ₨6,000) = ₨160,000 ≈ €508
LLM:      60 users × avg 5,000 tokens/day × 30 × $0.14/M ≈ €0.37
Infra:    €0 (still on free tier stack)
Credits:  Pure profit (markup already baked in)
Net:      > €507 (~₨160,000) | ~99% margin
```

**Month 6 — 200 mixed users + Hetzner migration:**
```
Revenue:  ≈ ₨600,000 ≈ €1,900
LLM:      ≈ €12 (DeepSeek Flash default)
Infra:    €4 (Hetzner CX22 + B2)
Credits:  +€150 estimated profit from premium model usage
Net:      > €2,034 | ~97% margin
```
