        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button className="hidden sm:flex items-center gap-1.5 text-sm text-[var(--ink-muted)] hover:text-[var(--ink)] px-2 py-1.5 rounded-md hover:bg-[var(--bg)] transition-colors">
          ...
          {/* Mobile hamburger */}
          <button
            className="sm:hidden p-1.5 rounded-md text-[var(--ink-muted)] hover:text-[var(--ink)]"
      ...
      {mobileOpen && (
        <div className="sm:hidden border-t border-[var(--hairline)] bg-[var(--surface)] px-4 py-3 space-y-1">
          ...
          <button
            ...
            className="w-full text-left px-3 py-2.5 text-sm text-[var(--ink-muted)] hover:text-[var(--ink)] flex items-center gap-2 min-h-[44px]"
          >
